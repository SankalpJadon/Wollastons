        ...
        <div class="container" >
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="list" class="nav navbar-nav">
                    ...
                    <li>
                       <a href="grocery.php">Groceries <span class="glyphicon glyphicon-chevron-down"></a>
                       <ul class="drop-down-menu">
                          <li><a href="grocery.php">Food</a></li>
                          <li><a href="grocery.php">Beverages</a></li>
                       </ul>
                    </li>
                    <li>
    ...
    <div class="container"> 
        <div class="row">
            <div id="image" style="position:relative; z-index:-1; top:50px; height:250px">
                ...
                <div class="address-bar animated bounceInLeft"><h3>DELI</h3></div>
            </div>
        </div>
    </div>